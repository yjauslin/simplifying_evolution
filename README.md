...
- workflow/
  ...
  - [scripts/](workflow/scripts/)
    - [calc_coalescent_densities.py](workflow/scripts/calc_coalescent_densitiy.py): Calculates the coalescent densities and writes the waves into result files based upon the simulation results from the forward-time simulations.
    - [visualize_coalescent_densities.py](workflow/scripts/visualize_densities.py): Plots the calculated densities plus the effective population size.
